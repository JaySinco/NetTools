...
SniffFrame_g::SniffFrame_g(wxWindow *parent, wxWindowID id, const wxString &title,
    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_splitter->Connect(wxEVT_IDLE, wxIdleEventHandler(SniffFrame_g::m_splitterOnIdle), NULL, this);
