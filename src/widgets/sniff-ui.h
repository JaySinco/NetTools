...
/// Class SniffFrame_g
///////////////////////////////////////////////////////////////////////////////
class SniffFrame_g : public wxFrame
{
private:
protected:
...
public:
    SniffFrame_g(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString &title = wxT("Sniff"),
    ...
    void m_splitterOnIdle(wxIdleEvent &)
    {
        ...
        m_splitter->Disconnect(wxEVT_IDLE, wxIdleEventHandler(SniffFrame_g::m_splitterOnIdle), NULL,
                               this);
    }
};
