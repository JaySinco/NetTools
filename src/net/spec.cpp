...
ip4_addr::ip4_addr(u_char c1, u_char c2, u_char c3, u_char c4) : b1(c1), b2(c2), b3(c3), b4(c4) {}
...
bool ip4_addr::operator!=(const ip4_addr &other) const { return !(*this == other); }
...
{
    return b1 == other.b1 && b2 == other.b2 && b3 == other.b3 && b4 == other.b4 && b5 == other.b5 &&
           b6 == other.b6;
}

bool eth_addr::operator!=(const eth_addr &other) const { return !(*this == other); }
...
std::ostream &operator<<(std::ostream &out, const _arp_header_detail &detail)
{
    ...
    switch (ntohs(detail.op)) {
        ...
        case ARP_REPLY_OP:
            ...
            out << "\tDescription: " << detail.sia << " tells " << detail.dia << ": i am at "
                << detail.sea << ".\n";
            break;
...
std::string get_icmp_error_desc(const icmp_header &header)
{
    ...
    switch (header.d.type) {
        case ICMP_TYPE_ERROR_UNREACHABLE:
            switch (header.d.code) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    desc = "Fragmentation needed but no frag. bit set";
                    break;
                case 5:
                    desc = "Source routing failed";
                    break;
                case 6:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    desc = "Source host isolated (obsolete)";
                    break;
                case 9:
                    desc = "Destination network administratively prohibited";
                    break;
                case 10:
                    desc = "Destination host administratively prohibited";
                    break;
                case 11:
        ...
        case ICMP_TYPE_ERROR_REDIRECTION:
            switch (header.d.code) {
                case 0:
                    desc = "Redirect for network";
                    break;
                case 1:
                    desc = "Redirect for host";
                    break;
                case 2:
                    desc = "Redirect for TOS and network";
                    break;
                case 3:
                    desc = "Redirect for TOS and host";
                    break;
            }
        case ICMP_TYPE_ERROR_TIMEOUT:
            switch (header.d.code) {
                case 0:
                    desc = "TTL equals 0 during transit";
                    break;
                case 1:
                    desc = "TTL equals 0 during reassembly";
                    break;
            }
        case ICMP_TYPE_ERROR_PARAMETER:
            switch (header.d.code) {
                case 0:
                    desc = "IP header bad (catch-all error)";
                    break;
                case 1:
                    desc = "Required options missing";
                    break;
            }
    }
    return desc;
