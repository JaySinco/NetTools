...
export MSVC_BUILD="MSBuild.exe -p:Configuration=RelWithDebInfo -maxcpucount *.sln"
export MSVC_INSTALL="MSBuild.exe -p:Configuration=RelWithDebInfo INSTALL.vcxproj"
